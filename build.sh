...
cd ../rpscript-api-open && npm run build  #stable:HIGH
cd ../rpscript-api-glob && npm run build  #stable:HIGH
cd ../rpscript-api-columnify && npm run build  #stable:HIGH
cd ../rpscript-api-adm-zip && npm run build #stable:MED
cd ../rpscript-api-lodash && npm run build
# cd ../rpscript-api-shelljs && npm run build
cd ../rpscript-api-figlet && npm run build  #stable:HIGH
cd ../rpscript-api-beeper && npm run build  #stable:HIGH
...
../rpscript-api-glob/build/index.js \
